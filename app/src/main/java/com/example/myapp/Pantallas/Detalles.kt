...
import com.example.myapp.componente.TarjetaProducto
...
fun Detalles(
    id: Int,
    navegaAtras: () -> Unit,
    miViewModel: TiendaViewModel = viewModel()
) {
    ...
    val listaProductos by miViewModel.productos.collectAsState()
            ...
            Column(
                ...
                Column(
                   ...
                   //nombre y precio
                    ...
                    Button(
                        onClick =  {miViewModel.añadirAlCarrito(producto) // Guarda el producto en el StateFlow
